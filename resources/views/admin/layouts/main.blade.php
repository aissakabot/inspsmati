...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admin/plugins/datatables/buttons.datables.min.css')}}">
  <!-- Font Awesome -->
...
<div class="wrapper">
 ...
 <header class="main-header">
    ...
    <a href="{{url('/adminpanel')}}" class="logo">
      ...
      <span class="logo-lg"><b>لوحة تحكم الموقع</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">لديك رسائل {{countunreadmessage()}} غير مقروؤة</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                @foreach(unreadmessage() as $unread)
                  <li><!-- start message -->
                    <a href="{{url('/adminpanel/contacts/'.$unread->id.'/edit')}}">
                      {{$unread->name}}
                    </a>
                  </li>
                  @endforeach
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{asset('admin/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="{{auth::user()->name}}">
