...
<ul class="breadcrumb">
   <li><a href="#">الرئيسية</a></li>
    <li class="active"><a href="{{url('activites')}}">الإنجازات</a></li>
</ul>

<div class="col-sm-9">
<h1  class="titre">قائمة النشاطات</h1>
...
<h1 style="text-align: center;font-weight: bold">{{$activite->title}}</h1> 


        

        <div class="over" style="text-align: center">
        <a  class="btn btn-info" href="{{url('/activites/'.$activite->id)}}"> طالع الموضوع</a>
        </div>
...
<div class="page text-center">{{ $activites->links() }}</div>
</div>


<div class="col-sm-3 hidden-xs">
<div class="derniernews">
<h1 class="text-center" style="font-size:20px;">آخر الأخبار</h1>
